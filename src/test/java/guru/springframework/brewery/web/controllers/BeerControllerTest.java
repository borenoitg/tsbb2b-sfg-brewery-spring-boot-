...
/**
 * @author : eanani
 * @project : tsbb2b-sfg-brewery-spring-boot-
 * @created : 12/04/2022,
 **/
...
class BeerControllerTest {
    ...
    class TestListOperations {
        ...
        @Captor
        ArgumentCaptor<PageRequest> beerPageRequestCaptor;
        ...
        void setUp() {
            ...
            given(beerService.listBeers(beerNameCaptor.capture(), beerStyleEnumCaptor.capture(),
                    beerPageRequestCaptor.capture())).willReturn(beerPagedList);
        }

        @DisplayName("the list beers - no parameters")
        @Test
